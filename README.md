...
First, setup an [ss-config](http://mirrors.slickstack.io/ss-config) file under the `/var/www/` directory (be sure to customize all relevant variables).

Next, install SlickStack [SS] with a single bash command:
