...
* **NEW!** SlickStack now supports custom throwaway themes that can be used to drill down into custom `wp_options` during the setup process... also a few more variables now like `SITE_NAME` and `SITE_EMAIL` to better support this approach...
