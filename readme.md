...
**NOTE: SlickStack [ss] will never support installing multiple TLDs on a single server. This is to ensure top speed, stability, and security, esp. as in regard to technical SEO. We will also never include any type of UI interface, to allow third party applications to integrate SlickStack with interfaces and management tools as they best see fit.**
