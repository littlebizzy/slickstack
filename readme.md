...
The below installation steps presume that you've already spun up a dedicated Ubuntu 16.04 VPS server with at least 2GB RAM memory and that you are logged in already via SSH.
