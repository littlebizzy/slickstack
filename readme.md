...
* [XXX Notices](https://github.com/littlebizzy/slickstack/blob/master/mu-plugins/xxx-notices.txt): Variable notices designed to appear in the WP Admin Dashboard that mention important changes regarding the SlickStack environment (white-labeled).
